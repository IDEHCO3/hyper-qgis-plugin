...
class IBGEVisualizer:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'IBGEVisualizer_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&IBGE Visualizer')

        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'IBGEVisualizer')
        self.toolbar.setObjectName(u'IBGEVisualizer')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('IBGEVisualizer', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/IBGEVisualizer/flag.png'

        self.add_action(
            icon_path,
            text=self.tr(u'Abrir IBGE Visualizer'),
            callback=self.run,
    ...
    def run(self):
        ...
        if self.dock_controller is None:
