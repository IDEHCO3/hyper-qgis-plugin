...
from IBGEVisualizer.modules.pyld.__about__ import (__copyright__, __license__, __version__)
...
__all__ = [
    ...
    'hyper_requests_document_loader',
...
#     from IBGEVisualizer.modules.pyld.documentloader import requests
#
#     return requests.requests_document_loader(**kwargs)
#
#
# def aiohttp_document_loader(**kwargs):
#     from IBGEVisualizer.modules.pyld.documentloader import aiohttp
#
#     return aiohttp.aiohttp_document_loader(**kwargs)


def hyper_requests_document_loader(**kwargs):
    from IBGEVisualizer.modules.pyld.documentloader import hyper_requests

    return hyper_requests.hyper_requests_document_loader(**kwargs)
...
try:
    _default_document_loader = hyper_requests_document_loader()
